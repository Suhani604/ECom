...
export default function AdminDashboard() {
  ...
  const statCards = [
    { label:'Total Buyers',     key:'totalBuyers',     Icon: FiUsers,       grad:'from-blue-500 to-indigo-500',   light:'bg-blue-50',   tc:'text-blue-600',   bc:'border-blue-100' },
    { label:'Total Sellers',    key:'totalSellers',    Icon: FiShoppingBag, grad:'from-violet-500 to-purple-500', light:'bg-violet-50', tc:'text-violet-600', bc:'border-violet-100' },
    { label:'Pending Sellers',  key:'pendingSellers',  Icon: FiClock,       grad:'from-amber-400 to-orange-500',  light:'bg-amber-50',  tc:'text-amber-600',  bc:'border-amber-100' },
    { label:'Active Products',  key:'activeProducts',  Icon: FiCheck,       grad:'from-emerald-400 to-teal-500',  light:'bg-emerald-50',tc:'text-emerald-600',bc:'border-emerald-100' },
    { label:'Pending Products', key:'pendingProducts', Icon: FiAlertCircle, grad:'from-orange-400 to-red-400',    light:'bg-orange-50', tc:'text-orange-600', bc:'border-orange-100' },
    { label:'Total Orders',     key:'totalOrders',     Icon: FiPackage,     grad:'from-teal-400 to-cyan-500',     light:'bg-teal-50',   tc:'text-teal-600',   bc:'border-teal-100' },
    { label:'Orders This Week', key:'recentOrders',    Icon: FiTrendingUp,  grad:'from-pink-400 to-rose-500',     light:'bg-pink-50',   tc:'text-pink-600',   bc:'border-pink-100' },
    { label:'Total Revenue',    key:'totalRevenue',    Icon: FiDollarSign,  grad:'from-green-500 to-emerald-600', light:'bg-green-50',  tc:'text-green-600',  bc:'border-green-100', prefix:'₹' },
  ]
    ...
    <div className="min-h-screen flex bg-slate-50" style={{ fontFamily:'Poppins, sans-serif' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-5 sm:p-7 space-y-7 max-w-7xl w-full mx-auto">
          ...
          {/* Welcome hero */}
          <div className="relative rounded-2xl overflow-hidden p-6 sm:p-8 shadow-lg shadow-pink-100"
            style={{ background:'linear-gradient(135deg,#ec4899,#f97316)' }}>
            ...
            <div className="relative">
              ...
              <p className="text-pink-100 text-sm">Here's your platform overview for today</p>
              <div className="flex flex-wrap gap-2 mt-4">
                {stats?.pendingSellers > 0 && (
                  <button onClick={() => navigate('/admin/sellers')}
                    className="bg-white/20 backdrop-blur-sm border border-white/30 text-white text-xs px-3 py-1.5 rounded-full font-semibold hover:bg-white/30 transition-all">
